...
- Strict `golangci-lint` (`default: none`) with the curated linter set in
  [../../AGENTS.md](https://github.com/platformrelay/MKurator/blob/main/AGENTS.md) — not the full 56-linter list.
...
- A real, local [SECURITY.md](https://github.com/platformrelay/MKurator/blob/main/SECURITY.md) and periodic `govulncheck`.
