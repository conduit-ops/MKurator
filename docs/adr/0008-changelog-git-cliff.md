...
[AGENTS.md](https://github.com/platformrelay/MKurator/blob/main/AGENTS.md)). Release artifacts are produced manually: bump
`charts/mkurator/Chart.yaml`, commit [`CHANGELOG.md`](https://github.com/platformrelay/MKurator/blob/main/CHANGELOG.md), tag
`v*`, and let [`.github/workflows/release.yaml`](https://github.com/platformrelay/MKurator/blob/main/.github/workflows/release.yaml)
build/push the image and publish install manifests via
[`hack/release-assets.sh`](https://github.com/platformrelay/MKurator/blob/main/hack/release-assets.sh).
...
- **[`cliff.toml`](https://github.com/platformrelay/MKurator/blob/main/cliff.toml)** at the repo root configures parsing, grouping,
...
- **[`CHANGELOG.md`](https://github.com/platformrelay/MKurator/blob/main/CHANGELOG.md)** is committed and regenerated with
...
- **Releases** stay manually versioned. On tag push, `orhun/git-cliff-action`
  runs `git cliff --latest --strip header`; [`hack/assemble-release-notes.sh`](https://github.com/platformrelay/MKurator/blob/main/hack/assemble-release-notes.sh)
...
- Implementation: [`cliff.toml`](https://github.com/platformrelay/MKurator/blob/main/cliff.toml), [`Taskfile.yml`](https://github.com/platformrelay/MKurator/blob/main/Taskfile.yml)
