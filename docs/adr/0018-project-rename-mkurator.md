...
- **Go module**: `github.com/platformrelay/mkurator`
- **GitHub / GHCR**: `github.com/platformrelay/MKurator`, `ghcr.io/platformrelay/mkurator`
...
- CI image references and `cliff.toml` repo updated to `platformrelay/MKurator`.
