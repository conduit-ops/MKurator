...
| Rule type | Sample |
| --- | --- |
| `ADDRESSMAP` | [channelauthrule.yaml](../../config/samples/messaging_v1alpha1_channelauthrule.yaml) |
| `BLOCKUSER` | [channelauthrule_blockuser.yaml](../../config/samples/messaging_v1alpha1_channelauthrule_blockuser.yaml) |
| `BLOCKADDR` | [channelauthrule_blockaddr.yaml](../../config/samples/messaging_v1alpha1_channelauthrule_blockaddr.yaml) |
...
[`config/samples/messaging_v1alpha1_authorityrecord.yaml`](../../config/samples/messaging_v1alpha1_authorityrecord.yaml)
...
[README.md#what-ci-proves](../../README.md#what-ci-proves).
