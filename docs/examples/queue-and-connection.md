...
[`config/samples/messaging_v1alpha1_queuemanagerconnection.yaml`](../../config/samples/messaging_v1alpha1_queuemanagerconnection.yaml)
...
[`config/samples/messaging_v1alpha1_queue.yaml`](../../config/samples/messaging_v1alpha1_queue.yaml)
...
| Variant | Sample |
| --- | --- |
| Alias queue | [queue_alias.yaml](../../config/samples/messaging_v1alpha1_queue_alias.yaml) |
| Remote queue | [queue_remote.yaml](../../config/samples/messaging_v1alpha1_queue_remote.yaml) |
| Topic | [topic.yaml](../../config/samples/messaging_v1alpha1_topic.yaml) |
| Channel | [channel.yaml](../../config/samples/messaging_v1alpha1_channel.yaml) |
