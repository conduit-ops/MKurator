...
> [../CONTRIBUTING.md](https://github.com/platformrelay/MKurator/blob/main/CONTRIBUTING.md)
...
testing, and agent workflow see [AGENTS.md](https://github.com/platformrelay/MKurator/blob/main/AGENTS.md).
...
Breaking commits appear under **Breaking Changes** in [CHANGELOG.md](https://github.com/platformrelay/MKurator/blob/main/CHANGELOG.md).
...
[`CHANGELOG.md`](https://github.com/platformrelay/MKurator/blob/main/CHANGELOG.md) is generated from git history, not hand-written
per bullet.
...
skipped ([`cliff.toml`](https://github.com/platformrelay/MKurator/blob/main/cliff.toml)).

## Before you open a PR or push

See [../CONTRIBUTING.md](https://github.com/platformrelay/MKurator/blob/main/CONTRIBUTING.md) for the full preflight checklist and merge policy.
Minimum before push:
...
| Doc | Topic |
|-----|--------|
| [../CONTRIBUTING.md](https://github.com/platformrelay/MKurator/blob/main/CONTRIBUTING.md) | Standards map, DCO, code review |
| [DEVELOPMENT.md](DEVELOPMENT.md) | Local setup, Task commands, test tiers |
| [AGENTS.md](https://github.com/platformrelay/MKurator/blob/main/AGENTS.md) | Go conventions, codegen, CI parity |
