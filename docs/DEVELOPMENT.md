...
agent workflow see [../AGENTS.md](https://github.com/platformrelay/MKurator/blob/main/AGENTS.md); for design see
[ARCHITECTURE.md](ARCHITECTURE.md).

The Git repository is [platformrelay/MKurator](https://github.com/platformrelay/MKurator); your
...
[hack/kind-cluster/README.md](https://github.com/platformrelay/MKurator/blob/main/hack/kind-cluster/README.md)).
...
| `task deploy:helm` | Operator via [Helm chart](https://github.com/platformrelay/MKurator/blob/main/charts/mkurator/README.md) (recommended on kind) |
...
**Helm e2e in CI:** [`.github/workflows/e2e.yaml`](https://github.com/platformrelay/MKurator/blob/main/.github/workflows/e2e.yaml) runs
...
> tiers is this section and [hack/kind-cluster/README.md](https://github.com/platformrelay/MKurator/blob/main/hack/kind-cluster/README.md).
> [README.md](https://github.com/platformrelay/MKurator/blob/main/README.md) and [INSTALL_AND_USE.md](INSTALL_AND_USE.md) link here
...
Example `QueueManagerConnection` (same as [samples](https://github.com/platformrelay/MKurator/tree/main/config/samples)):
...
[charts/mkurator/README.md](https://github.com/platformrelay/MKurator/blob/main/charts/mkurator/README.md).
...
Same tiers as [README.md#what-ci-proves](https://github.com/platformrelay/MKurator/blob/main/README.md#what-ci-proves) (summary table).
...
See [`hack/mq-docker/README.md`](https://github.com/platformrelay/MKurator/blob/main/hack/mq-docker/README.md).
...
documented in [`test/e2e/fixtures/README.md`](https://github.com/platformrelay/MKurator/blob/main/test/e2e/fixtures/README.md).
