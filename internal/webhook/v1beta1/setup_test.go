...
func TestAdmissionResult_WithErrors(t *testing.T) {
	...
	_, err := admissionResult(nil, errs, validation.QueueInvalidV1Beta1, "orders")
	if err == nil {
...
func TestAdmissionResult_NoErrors(t *testing.T) {
	t.Parallel()
	warnings, err := admissionResult([]string{"deprecated field"}, nil, validation.QueueInvalidV1Beta1, "orders")
	if err != nil {
