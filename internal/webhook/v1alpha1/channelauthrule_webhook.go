...
// +kubebuilder:webhook:path=/validate-messaging-kurator-dev-v1alpha1-channelauthrule,mutating=false,failurePolicy=fail,sideEffects=None,groups=messaging.kurator.dev,resources=channelauthrules,verbs=create;update,versions=v1alpha1,name=vchannelauthrule.kb.io,admissionReviewVersions=v1
