...
// +kubebuilder:webhook:path=/validate-messaging-kurator-dev-v1alpha1-topic,mutating=false,failurePolicy=fail,sideEffects=None,groups=messaging.kurator.dev,resources=topics,verbs=create;update,versions=v1alpha1,name=vtopic.kb.io,admissionReviewVersions=v1
